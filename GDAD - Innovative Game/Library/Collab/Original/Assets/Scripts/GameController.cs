...
public class GameController : MonoBehaviour {
    ...
    public void spawnPowerUp(Transform location)
    {
        ...
        if (x == 1)
        {
            GameObject powerUp = Instantiate(powerUpwpnLVL, location.position, location.rotation) as GameObject;
        }
        else if(x == 49)
        {
            GameObject powerUp = Instantiate(powerUpDMG, location.position, location.rotation) as GameObject;
        }
        else if (x == 99)
        {
            GameObject powerUp = Instantiate(powerUpSPEED, location.position, location.rotation) as GameObject;
        }
        else if (x == 120)
        {
            GameObject powerUp = Instantiate(GpowerUpwpnLVL, location.position, location.rotation) as GameObject;
        }
        else if (x == 150)
        {
            GameObject powerUp = Instantiate(GpowerUpDMG, location.position, location.rotation) as GameObject;
        }
        else if (x == 199)
        {
            GameObject powerUp = Instantiate(GpowerUpSPEED, location.position, location.rotation) as GameObject;
        }
    }
    ...
    {
        GameObject P = Instantiate(player, playerSpawn.position, playerSpawn.rotation) as GameObject;
    }
